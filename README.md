[![Stories in Ready](https://badge.waffle.io/CreativeSDK/phonegap-plugin-csdk-asset-browser.png?label=ready&title=Ready)](https://waffle.io/CreativeSDK/phonegap-plugin-csdk-asset-browser)
<!--
#
